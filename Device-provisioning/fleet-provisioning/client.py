...
def provision_device(
    ...
    try:
        ...
        identity_client = iotidentity_wrapper.get_iot_identity_client(
           mqtt_connection
        )

        create_keys_response = iotidentity_wrapper.subscribe_to_create_keys_and_certificate_accepted(
            identity_client=identity_client
        )

        register_thing_response = iotidentity_wrapper.register_thing_subscription_request(
            identity_client=identity_client,
        ...
        return {
            'certificate': create_keys_response,
            'thing': register_thing_response
        }
