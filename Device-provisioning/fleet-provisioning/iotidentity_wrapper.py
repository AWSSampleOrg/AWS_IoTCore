...
def register_thing_subscription_request(
    ...
    register_thing_accepted_future, _ = identity_client.subscribe_to_register_thing_accepted(
    ...
    register_thing_rejected_future, _ = identity_client.subscribe_to_register_thing_rejected(
        request=register_thing_subscription_request,
        qos=mqtt.QoS.AT_LEAST_ONCE,
...
def subscribe_to_create_keys_and_certificate_accepted(
    ...
    create_keys_accepted_future, _ = identity_client.subscribe_to_create_keys_and_certificate_accepted(
    ...
    create_keys_rejected_future, _ = identity_client.subscribe_to_create_keys_and_certificate_rejected(
        request=create_keys_subscription_request,
        qos=mqtt.QoS.AT_LEAST_ONCE,
